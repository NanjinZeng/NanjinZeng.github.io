...
# Rescale the data using the function MinMaxScaler
import warnings
...
# Deep neural network for continuous features, the model has 5 hidden layers with respectly 200, 100,50,25 and 12 units and the function of activation will be Relu
# Model
...
# Data submission and an illustration of the difference between the reality and the predictions.
